...
<head>
    ...
    <title>Processing - Fridge AI</title>
...
<body>
    ...
    <div class="shell">
        <header class="hero small">
            ...
            <p class="subtitle" id="statusLine">Warming up the pipeline...</p>
        </header>
        ...
        <div id="result" class="result hidden">
            ...
            <div class="tabs" id="tabs">
                ...
                <button class="tab-btn" data-tab="recipe">Recipe</button>
            </div>

            <div id="tab-detection" class="tab-panel active">
                <section class="panel overview-panel hidden" id="overviewPanel">
                    <h2>Multi-Object Detection</h2>
                    <p class="muted small-muted" id="overviewCaption"></p>
                    <div class="overview-wrap">
                        <img id="overviewImage" src="">
                    </div>
                </section>
                ...
                <section class="panel">
                    <div class="panel-header-row">
                        ...
                        <span class="muted small-muted">Uncheck anything that's wrong, then regenerate</span>
                    </div>
                    <div id="detectionGrid" class="detection-grid"></div>
                    <button id="regenerateBtn" class="btn-primary regen-btn hidden">Regenerate Recipe</button>
                </section>
            </div>

            <div id="tab-retrieval" class="tab-panel">
                <section class="panel">
                    <h2>Retrieved Reference Recipes</h2>
                    <p class="muted small-muted">Click a recipe to see the full reference text used as context</p>
                    <div id="recipeList" class="recipe-pills"></div>
                </section>
            </div>

            <div id="tab-recipe" class="tab-panel">
                <section class="panel" id="missingPanel" style="display:none;">
                    <h2>Shopping List</h2>
                    <p class="muted small-muted">Add these to make the dish even better</p>
                    <div id="missingList" class="missing-list"></div>
                </section>

                <section class="panel">
                    <h2>Your Recipe</h2>
                    <div id="finalRecipe" class="recipe-card"></div>
                </section>

                <details class="logs-panel prompt-panel">
                    <summary>How this recipe was made (view the actual LLM prompt)</summary>
                    <pre id="promptView" class="prompt-view"></pre>
                </details>
            </div>

            <a href="/" class="btn-secondary">Try another video</a>
        </div>
...
with open("templates/processing.html", "w", encoding="utf-8") as f:
    f.write(content)

print("Wrote templates/processing.html successfully,", len(content), "characters")
